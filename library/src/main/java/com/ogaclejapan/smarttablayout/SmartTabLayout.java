...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  private LazyViewPager.OnPageChangeListener lazyPagerChangeListener;
  private ViewPager.OnPageChangeListener viewPagerPageChangeListener;
  private OnScrollChangeListener onScrollChangeListener;
  private TabProvider tabProvider;
  private InternalTabClickListener internalTabClickListener;
  private  InternalTabLazyClickListener mInternalTabLazyClickListener;
  ...
  public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    this. mInternalTabLazyClickListener= clickable ? new InternalTabLazyClickListener() : null;
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if (changed && mLazyViewPager != null) {
      scrollToTab(mLazyViewPager.getCurrentItem(),0);
    }
  }
  ...
  public void setOnPageChangeListener(LazyViewPager.OnPageChangeListener listener) {
    lazyPagerChangeListener = listener;
  }
  /**
  ...
  public void setLazyViewPager(LazyViewPager lazyViewPager) {
    ...
    if (lazyViewPager != null && lazyViewPager.getAdapter() != null) {
      lazyViewPager.setOnPageChangeListener(new InternalLazyViewPagerListener());
      populateTabStrip2();
    }
  }
  ...
  private void populateTabStrip2() {
    final PagerAdapter adapter = mLazyViewPager.getAdapter();
    ...
    if (mInternalTabLazyClickListener!=null){
      tabView.setOnClickListener(mInternalTabLazyClickListener);
    }
      tabStrip.addView(tabView);
      if (i == mLazyViewPager.getCurrentItem()) {
  ...
  private class InternalLazyViewPagerListener implements LazyViewPager.OnPageChangeListener {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
      ...
      if (lazyPagerChangeListener != null) {
        lazyPagerChangeListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
      }
      if (lazyPagerChangeListener != null) {
        lazyPagerChangeListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
      }
    ...
    public void onPageSelected(int position) {
      ...
      if (lazyPagerChangeListener != null) {
        lazyPagerChangeListener.onPageSelected(position);
      }
    }
    ...
    public void onPageScrollStateChanged(int state) {
      ...
      if (lazyPagerChangeListener != null) {
        lazyPagerChangeListener.onPageScrollStateChanged(state);
      }
  ...
  private class InternalTabLazyClickListener implements OnClickListener {
    @Override
    public void onClick(View v) {
      for (int i = 0; i < tabStrip.getChildCount(); i++) {
        if (v == tabStrip.getChildAt(i)) {
          ...
          mLazyViewPager.setCurrentItem(i);
          return;
        }
      }
    }
